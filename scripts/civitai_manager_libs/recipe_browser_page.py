...
def on_ui():
    ...
    recipe_gallery = gr.Gallery(value=thumb_list, show_label=False, grid=[5], height="100%", object_fit=setting.gallery_thumbnail_image_style, preview=False)
    ...
    with gr.Accordion(label="Filter Reference Shortcut Items", open=False):      
        recipe_reference_select_gallery = gr.Gallery(elem_id="recipe_select_reference_gallery", label="Filter Reference Models", grid=[setting.shortcut_column], height="auto", object_fit=setting.gallery_thumbnail_image_style, preview=False)
        ...
        recipe_reference_gallery = gr.Gallery(value=reference_list, show_label=False, grid=[5], height="100%", object_fit=setting.gallery_thumbnail_image_style, preview=False)
