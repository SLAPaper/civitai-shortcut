...
def on_ui(recipe_input):
    ...
    with gr.Column(scale=3):                                                   
        ...
        usergal_gallery = gr.Gallery(show_label=False, elem_id="user_gallery", grid=[setting.usergallery_images_column], height=setting.information_gallery_height, object_fit=setting.gallery_thumbnail_image_style)
        with gr.Row():                  
